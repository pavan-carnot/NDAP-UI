      ...
      <div className="max-w-screen-xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-7 h-7 bg-ndap-saffron rounded flex items-center justify-center text-xs font-bold text-white">M</div>
              <span className="font-semibold text-sm">MNRE</span>
            </div>
            <p className="text-blue-200 text-xs leading-relaxed">
              Ministry of New and Renewable Energy — Government of India,
              empowering citizens with open data access and AI-driven insights
              on renewable energy.
            </p>
          </div>
        ...
        <div className="border-t border-white/10 mt-6 pt-5 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-blue-300 text-[11px]">
            © 2024 Ministry of New and Renewable Energy, Government of India. All rights reserved.
          </p>
          <p className="text-blue-400 text-[11px]">
            Content on this site is published by MNRE — GovData Analyst POC
          </p>
        </div>
      </div>
    </footer>
